...
public class AdminServiceImpl implements AdminService {
    ...
    public Statistics getStatistics() {
        ...
        return Statistics.builder()
            ...
            .approvedReservations(
                massReservations.stream().filter(MassReservation::isActive).count())
    ...
    public void disableMass(int id) {
        ...
        Mass mass = optionalMass
            .orElseThrow(() -> new EntityNotFoundException("عفوا لا توجد قداسات"));
    ...
    private void writeHeaderLine(XSSFWorkbook workbook, XSSFSheet sheet) {
        ...
        createCell(sheet, row, 3, "المكان", style);
